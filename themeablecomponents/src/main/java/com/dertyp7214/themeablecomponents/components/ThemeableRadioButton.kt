...
open class ThemeableRadioButton : AppCompatRadioButton {
    ...
    private fun init() {
        ...
        onThemeChangeListener = object : OnThemeChangeListener {
            override val type: ThemeManager.Component.TYPE
                get() = ThemeManager.Component.TYPE.RADIOBUTTON
            override val id: String
                get() = getIdFromView(this@ThemeableRadioButton)
    ...
    private fun applyTheme(theme: Theme, animated: Boolean) = if (animated) {
        val animator = ValueAnimator
                .ofObject(ArgbEvaluator(), buttonTintList!!.defaultColor,
                        theme.color)
