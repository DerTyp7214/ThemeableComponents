...
public class ThemeableRadioButton extends AppCompatRadioButton {
    ...
    public ThemeableRadioButton(Context context) {
        super(context);
        this.context=context;
        init();
    }

    public ThemeableRadioButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context=context;
        init();
    }

    public ThemeableRadioButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void applyTheme(Theme theme, boolean animated) {
        if (animated) {
            ValueAnimator animator = ValueAnimator
                    .ofObject(new ArgbEvaluator(), Objects.requireNonNull(getButtonTintList()).getDefaultColor(),
                            theme.getColor());
